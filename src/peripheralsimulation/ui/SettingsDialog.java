...
import peripheralsimulation.io.ConfigIO;
import peripheralsimulation.io.ConfigIO.SimulationConfig;
...
public class SettingsDialog extends Dialog {
	...
	private void addConfigYamlButton(Composite dialog) {
		...
		importYamlButton.addListener(SWT.Selection, e -> {
			...
			try {
				SimulationConfig config = ConfigIO.loadYaml(file);
				userPreferences.apply(config.preferences());
				userPreferences.setUserEvents(config.events());
